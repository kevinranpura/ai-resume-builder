  ...
  return (
    <>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-5 mx-3 md:mx-8 lg:mx-15 my-5'>
        ...
        <div className="md:hidden flex items-center py-3 px-3 text-sm text-yellow-600 border-3 border-dashed border-yellow-300 rounded-lg bg-yellow-100" role="alert">
