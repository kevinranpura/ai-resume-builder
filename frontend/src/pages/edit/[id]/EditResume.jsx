            ...
            <div id="popup-modal" tabIndex="-1" className={`${showdelete ? "" : "hidden"} flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 mx-[27px] md:mx-0 z-50 justify-center w-80 md:w-full md:inset-0 h-[calc(100%-1rem)]`}>
              <div className="items-center p-4 w-full max-w-md max-h-full">
                <div className="relative bg-white rounded-lg shadow-sm">
                  <button onClick={() => setshowdelete(!showdelete)} type="button" className="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center " data-modal-hide="popup-modal">
                  ...
                  <div className="p-4 md:p-5 text-center">
                    ...
                    <h3 className="mb-5 text-lg font-normal text-gray-500 ">Are you sure you want to delete this resume?</h3>
                    <button onClick={deleteresume} data-modal-hide="popup-modal" type="button" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                      Yes, I'm sure
                    </button>
